<?php
/**
 * Template Name: Full width image Sidebar
  ...
  <div id="content" class="site-content">
    <div id="primary" class="content-area">
      ...
      <main id="main" class="site-main">
        ...
        if ( locate_template("template-parts/content/{$post_type}/single-full-width-image.php") ) {
          get_template_part("template-parts/content/{$post_type}/single-full-width-image");
        } else {
        ?>
