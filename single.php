...
<div id="content" class="site-content <?= apply_filters('bootscore/class/container', 'container', 'single'); ?> <?= apply_filters('bootscore/class/content/spacer', 'pt-3 pb-5', 'single'); ?>">
  <div id="primary" class="content-area">
    ...
    <div class="row">
      <div class="<?= apply_filters('bootscore/class/main/col', 'col-12'); ?>">
        ...
        <main id="main" class="site-main">
          ...
          <div class="entry-footer clear-both">
            ...
            <?php // if (function_exists('bootscore_related_posts') && get_post_type() !== 'formazione') bootscore_related_posts(); ?>
